...
// SortKVByLength returns a sorted slice of KVPair order by len of key
...
// SortByLength return a sorted slice of string order by string length
...
// UnmarshalJSONObject  unmarshal a json object into a map
...
// LookupIP look up host for ip addresses
...
// Base64Encode base64 encoding string
func Base64Encode(data string) string {
	return base64.StdEncoding.EncodeToString([]byte(data))
}

// Base64Decode base64 decoding string
